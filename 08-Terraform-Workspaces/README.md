...
Go to AWS Mgmt Console -> Services -> S3 -> terraform-tflearning -> workspaces -> terraform.tfstate
```
...
Go to AWS Mgmt Console -> Services -> S3 -> terraform-tflearning -> env:/ -> dev -> workspaces -> terraform.tfstate
```
